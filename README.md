...
Современный веб-интерфейс для мониторинга кластера 1С:Предприятие RAS на порту 8080. Сервис построен на FastAPI и отображает ключевые показатели: инфобазы, сеансы, соединения, процессы, блокировки и лицензии.
...
- Дашборд уровня enterprise: графики, метрики, таблицы.
- Адаптивный интерфейс на Tailwind CSS и ApexCharts.
